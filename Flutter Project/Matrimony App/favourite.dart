...
User user= User();
  ...
  void initState() {
    ...
    for(var element in User.userList){
      if(element[MatromonialDatabase.FAV]==1){
  ...
  Widget getUserList(i){
    return Card(
      ...
      child: ListTile(
        ...
        }, icon: User.favouriteList[i]["FAV"]==1 ?Icon(Icons.favorite,color: Colors.red,):Icon(Icons.favorite_border_sharp,color: Colors.white,)),
      ),
    );
  }
